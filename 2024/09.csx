...
var input = File.ReadAllText("2024/inputs/09.real.txt");
...
// ######
{
	...
	checksum.Dump("Part 1").Should().BeOneOf(1928, 6384282079460);
}
...
// ######
{
	...
	checksum.Dump("Part 1 Optimised").Should().BeOneOf(1928, 6384282079460);
}
...
// ######
{
	...
	checksum.Dump("Part 2").Should().BeOneOf(2858, 6408966547049);
}